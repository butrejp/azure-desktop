...
# --- 1. Fix repo files for Azure Linux environment ---
...
# --- 2. Disable repos that conflict with Azure Linux or are unnecessary ---
...
# --- 3. Clean caches so next dnf module starts fresh ---
dnf5 clean all
